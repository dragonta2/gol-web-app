...
M1でクラウドコードの設定とかを同期させたいので、この資料を読んでやってみて



envはM1から持ってくれば解決するのであとでやります。

ClaudeCodeの方はどうなってるんだっけ？？

Volta版
npm版
どっちもアンインストールして、新しいものを
インストール済み？？


M1のほう確認したら、昨日は表示されていたのに
今日は表示されてなかった。やはりAPIの不具合障害なのかな。
